export const HERO_CARDS: string[] = ['image-11.png', 'image-12.png', 'image-1370.png', 'image-11.png', 'image-12.png']

export const HERO_DETAILS: [string, string][] = [
  ['Donruss 90 - Juan Gongaley of Rangers', 'Batter up-submit Baseball Cards 2020-Present at just $16.99/card.'],
  ['Topps 89 - Mark McGwire of A’s', 'Exclusive Baseball Cards. Collector’s Edition from $19.99/card.'],
  ['Upper Deck 91 - Ken Griffey Jr.', 'Limited Edition. Baseball Cards for Hall of Famers starting at $24.99/card.']
]
