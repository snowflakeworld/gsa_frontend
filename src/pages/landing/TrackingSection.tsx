...
import { PriceItemHoriz } from './tracking/PriceItemHoriz'
import { PriceItemVert } from './tracking/PriceItemVert'
...
const TrackingCard: FC<TrackingCardProps> = ({ title, description, content, img, itemDisplayMode, items }) => {
